...
namespace Ecole
{
    ...
    {
        private const string teachersFile = "Prof.txt";
        private const string activitiesFile = "Activite.txt";
        private const string studentsFile = "Etudiants.txt";
        private const string evaluationsFile = "Evaluations.txt";

        private static SchoolData instance = null;
